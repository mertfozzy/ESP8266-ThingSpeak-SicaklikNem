...
String agAdi = "Mert-VodafoneNet";                 //Ağımızın adını buraya yazıyoruz.    
...
void loop() {
  ...
  String veri = "GET https://api.thingspeak.com/update?api_key=90R3F3AKAQK2OSA1";   //Thingspeak komutu. Key kısmına kendi api keyimizi yazıyoruz.                                   //Göndereceğimiz sıcaklık değişkeni
  veri += "&field1=";
